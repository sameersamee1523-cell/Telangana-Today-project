...
function DashboardRouter() {
  ...
  if (user.role === 'admin') return <AdminDashboard title="Admin Dashboard" />
  if (user.role === 'chief_editor') return <AdminDashboard title="Chief Editor Dashboard" />
  if (user.role === 'editor') return <EditorDashboard />
  if (user.role === 'photographer') return <PhotographerDashboard />
