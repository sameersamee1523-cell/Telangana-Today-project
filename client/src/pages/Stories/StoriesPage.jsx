...
import { Plus, LayoutGrid, List, Search, X, BookOpen, Activity, ChevronRight } from 'lucide-react'
...
function KanbanCard({ story, index }) {
  return (
                      ...
                      {(provided, snapshot) => (
                        ...
                        >
                          {(kanban[col.id] || []).map((story, idx) => (
                            <KanbanCard key={story.id} story={story} index={idx} />
                          ))}
              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <th>Category</th><th>Deadline</th><th></th>
                  </tr>
                </thead>
                <tbody>
                  {stories.map(s => (
                    <tr key={s.id}>
                      ...
                      <td>
                        <Link to={`/stories/${s.id}`} className="text-surface-400 hover:text-primary-500 transition">
